...
const deleteEvent = async () => {
  try {
    await axios.delete(`https://json-server-pied-seven.vercel.app/api/events/${String(selectedEvent.value.id)}`);
...
const saveEvent = async () => {
  try {
    ...
    if (isNewEvent.value) {
      ...
      const response = await axios.post(`https://json-server-pied-seven.vercel.app/api/events`, eventToSave);
      ...
      const response = await axios.put(`https://json-server-pied-seven.vercel.app/api/events/${eventToSave.id}`, eventToSave);
